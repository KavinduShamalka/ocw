...
impl pallet_bucket_feature::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type AuthorityId = pallet_bucket_feature::crypto::TestAuthId;
}
...
construct_runtime!(
	pub struct Runtime {
		...
		Bucketfeature: pallet_bucket_feature,
	}
);
