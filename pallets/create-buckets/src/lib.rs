...
// 			match Self::fetch_bucket_and_send_signed() {
// 				Ok(name) => log::info!("Fetched name: {:?}", name),
...
// 		pub fn get_bucket_name(origin: OriginFor<T>, name: String) -> DispatchResult<String, DispatchError> {
...
// 		pub fn fetch_bucket_name() -> Result<String, http::Error> {
...
// 				match res {
// 					Ok(()) => log::info!("{:?} name get success: {}.", acc.id, name),
